...
public class GraphController {
    ...
    public void createAndAddVertex(IGraph<Stop> graph, String name, String lineId, String id, double x, double y, String orientation) {

        Stop s = new Stop(name, lineId, id, x, y, orientation);
        graph.add(s);
